...
meta = [
    ...
    "metrics" : [
      {
        ...
        "description" : "The Jensen-Shannon Distance, which is the square root of Jensen-Shannon Divergence is a symmetric method for measuring the similarity between two probability distributions. The similarity between the distributions is greater when the Jensen-Shannon distance is closer to zero.\n",
        "references" : {
  ...
  "build_info" : {
    "config" : "/home/runner/work/task_spatial_decomposition/task_spatial_decomposition/src/metrics/jsd/config.vsh.yaml",
    "runner" : "nextflow",
    "engine" : "docker",
    "output" : "target/nextflow/metrics/jsd",
    "viash_version" : "0.9.0",
...
meta["defaults"] = [
  ...
  "container" : {
    "registry" : "ghcr.io",
    "image" : "openproblems-bio/task_spatial_decomposition/metrics/jsd",
    "tag" : "build_main"
  },
  "label" : [
    "midtime",
